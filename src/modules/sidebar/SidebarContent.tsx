...
export default function SidebarContent({
  ...
  return (
    <div
      className="flex h-full flex-col bg-background/80 backdrop-blur-sm md:w-[var(--sidebar-w,230px)] md:select-none"
      style={{}}
    >
      <SidebarHeader
        isPWA={isPWA}
      ...
      <ScrollArea className="flex-1 overflow-y-auto overscroll-contain md:px-1.5 md:pt-2">
